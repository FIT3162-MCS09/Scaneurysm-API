...
import base64
from .model_service import CNNModel  # Import your model from model_service
import boto3
...
class ShapAnalysisService:
    def __init__(self):
        ...
        self.bucket_name = 'mcs09-bucket'
        
        # Load the model state
        state_dict = torch.load('src/api/model.pth', map_location=self.device)
